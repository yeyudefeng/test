...
public class MysqlUtils {
    ...
    public static ArrayList<EDT> queryCreateSqlFromMysql(String jdbc, String username, String password, ArrayList<EDT> list, String writePath){
        ArrayList<EDT> tables = new ArrayList<>();
        ...
        try {
            ...
            for (EDT dt : list) {
                ...
                ArrayList<EField> fields = new ArrayList<>();
                while (rs.next()){
                    String field = rs.getString(1);
                    String type = rs.getString(2);
                    String comment = rs.getString(3);
                    fields.add(new EField(field, type, comment));
                }
                ...
                tables.add(new EDT(dt.database, dt.tablename, createSql, fields, tableComment));
